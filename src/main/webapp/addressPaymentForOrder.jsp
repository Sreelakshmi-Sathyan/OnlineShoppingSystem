...
<div class="right-div">
<h3>Pay online on this onlineshopping@icici</h3>
<input class="input-style" type="text" name="transactionId" placeholder="Enter Transaction ID" required>
<h3 style="color: red">*Enter you transaction ID here, for payment Confirmation.</h3>
</div>
<hr style="width: 100%">
...
<h3 style="color: red">*Please provide the proper Details </h3>
</div>
</form>
